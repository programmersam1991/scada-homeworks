...
Понимание базовых принципов построения SCADA систем является основопологающими знаниями в области SCADA. Правильно построенная и надежно зациценная SCADA это один из важнейших шагов к построению надежной и продолжительной системы автоматизации. В результате выполнения этого задания вы научитесь правильной расстановке органов управления, определять архитектуру SCADA, выявлять риски и разрабатывать меры по предотвращению рисков в работе SCADA систем (задание со *).
